...
void init_explosion(Viewer &viewer, ShaderProgramPtr phong_shader)
{
    ...
    const std::string explosion_path = "../../assets/obj/explosion.obj";
    ...
    root_explosion->addGlobalTransformKeyframe(
        getTranslationMatrix(30, 5.0, -5.0) * getScaleMatrix(0.1, 0.1, 0.1),
        0);
    root_explosion->addGlobalTransformKeyframe(
        getTranslationMatrix(20, 5.0, -5.0) * getScaleMatrix(1, 1, 1),
        1.7);
    root_explosion->addGlobalTransformKeyframe(
        getTranslationMatrix(20, 5.0, -5.0) * getScaleMatrix(0.01, 0.01, 0.01),
        2);
    root_explosion->addGlobalTransformKeyframe(
        getTranslationMatrix(20, 5.0, -5.0) * getScaleMatrix(0.01, 0.01, 0.01),
        5);
...
void scene6(Viewer &viewer)
{
    ...
    for (int i = 0; i < ground_pieces_x; ++i)
    {
        for (int j = 0; j < ground_pieces_z; ++j)
        {
            ...
            glm::mat4 translation = getTranslationMatrix(30 + (i - ground_pieces_x / 2) * ground_size, elevation, (j - ground_pieces_z / 2) * ground_size);
            ...
            if ((j <= ground_pieces_z / 3 || j >= 2 * ground_pieces_z / 3) && dis_tree(gen) < 0.2)
            {
                ...
                tree->setGlobalTransform(
                    getTranslationMatrix(30 + (i - ground_pieces_x / 2) * ground_size, elevation, (j - ground_pieces_z / 2) * ground_size));
    ...
    car->addGlobalTransformKeyframe(
        ...
        0);
    car->addGlobalTransformKeyframe(
        getTranslationMatrix(20, 2, -5) * getScaleMatrix(0.4, 0.4, 0.4) * getRotationMatrix(3.14 / 4, glm::vec3(1, 0, 0)),
        1.5);
    car->addGlobalTransformKeyframe(
        getTranslationMatrix(19, 2, -5) * getScaleMatrix(0.4, 0.4, 0.4) * getRotationMatrix(3.14 / 2, glm::vec3(1, 0, 0)),
        1.7);
    car->addGlobalTransformKeyframe(
        getTranslationMatrix(16, 2, -5) * getScaleMatrix(0.4, 0.4, 0.4) * getRotationMatrix(3.14 / 2, glm::vec3(1, 0, 0)),
        3);
    car->addGlobalTransformKeyframe(
        getTranslationMatrix(15, 2, -5) * getScaleMatrix(0.4, 0.4, 0.4) * getRotationMatrix(3.14 / 2, glm::vec3(1, 0, 0)),
        4);
    car->addGlobalTransformKeyframe(
        getTranslationMatrix(14.5, 2, -5) * getScaleMatrix(0.4, 0.4, 0.4) * getRotationMatrix(3.14 / 2, glm::vec3(1, 0, 0)),
        5);
    ...
    camera.addGlobalTransformKeyframe(
        getTranslationMatrix(37, 25, -10) * getRotationMatrix(3.14 / 2, glm::vec3(-1, 0, 0)),
        0);
    camera.addGlobalTransformKeyframe(
        getTranslationMatrix(27, 25, -10) * getRotationMatrix(3.14 / 2, glm::vec3(-1, 0, 0)),
        1.5);
    camera.addGlobalTransformKeyframe(
        getTranslationMatrix(27, 25, -10) * getRotationMatrix(3.14 / 2, glm::vec3(-1, 0, 0)),
        5);
