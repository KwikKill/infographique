...
void initialize_scene( Viewer& viewer )
{
    ...
    root->addGlobalTransformKeyframe(getTranslationMatrix(10, 0, 0), 10);
    root->addGlobalTransformKeyframe(getTranslationMatrix(20, 0, 0), 20);
    root->addGlobalTransformKeyframe(getTranslationMatrix(30, 0, 0), 30);
    root->addGlobalTransformKeyframe(getTranslationMatrix(40, 0, 0), 40);
